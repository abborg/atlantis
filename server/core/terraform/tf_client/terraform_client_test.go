...
import (
	...
	"github.com/runatlantis/atlantis/server/core/terraform/tf_client"
...
`
	...
	c, err := tf_client.NewClient(logger, distribution, binDir, cacheDir, "", "", "", cmd.DefaultTFVersionFlag, cmd.DefaultTFDownloadURL, true, true, projectCmdOutputHandler)
	Ok(t, err)
...
`
	...
	c, err := tf_client.NewClient(logger, distribution, binDir, cacheDir, "", "", "0.11.10", cmd.DefaultTFVersionFlag, cmd.DefaultTFDownloadURL, true, true, projectCmdOutputHandler)
	Ok(t, err)
...
func TestNewClient_NoTF(t *testing.T) {
	...
	_, err := tf_client.NewClient(logger, distribution, binDir, cacheDir, "", "", "", cmd.DefaultTFVersionFlag, cmd.DefaultTFDownloadURL, true, true, projectCmdOutputHandler)
...
func TestNewClient_DefaultTFFlagInPath(t *testing.T) {
	...
	c, err := tf_client.NewClient(logger, distribution, binDir, cacheDir, "", "", "0.11.10", cmd.DefaultTFVersionFlag, cmd.DefaultTFDownloadURL, false, true, projectCmdOutputHandler)
	Ok(t, err)
...
func TestNewClient_DefaultTFFlagInBinDir(t *testing.T) {
	...
	c, err := tf_client.NewClient(logging.NewNoopLogger(t), distribution, binDir, cacheDir, "", "", "0.11.10", cmd.DefaultTFVersionFlag, cmd.DefaultTFDownloadURL, true, true, projectCmdOutputHandler)
	Ok(t, err)
...
func TestNewClient_BadVersion(t *testing.T) {
	...
	mockDownloader := mocks.NewMockDownloader()
	distribution := terraform.NewDistributionTerraformWithDownloader(mockDownloader)
	_, err := tf_client.NewClient(logger, distribution, binDir, cacheDir, "", "", "malformed", cmd.DefaultTFVersionFlag, cmd.DefaultTFDownloadURL, true, true, projectCmdOutputHandler)
...
func TestEnsureVersion_downloaded(t *testing.T) {
	...
	c, err := tf_client.NewTestClient(logger, distribution, binDir, cacheDir, "", "", "0.11.10", cmd.DefaultTFVersionFlag, cmd.DefaultTFDownloadURL, downloadsAllowed, true, projectCmdOutputHandler)
	Ok(t, err)
...
func TestEnsureVersion_downloaded_customURL(t *testing.T) {
	...
	c, err := tf_client.NewTestClient(logger, distribution, binDir, cacheDir, "", "", "0.11.10", cmd.DefaultTFVersionFlag, customURL, downloadsAllowed, true, projectCmdOutputHandler)
	Ok(t, err)
...
func TestExtractExactRegex(t *testing.T) {
	...
	c, err := tf_client.NewTestClient(logger, distribution, binDir, cacheDir, "", "", "0.11.10", cmd.DefaultTFVersionFlag, cmd.DefaultTFDownloadURL, true, true, projectCmdOutputHandler)
	Ok(t, err)
